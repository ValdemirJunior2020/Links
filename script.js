function checkPassword() {
    ...
    if (enteredPassword === 'qa2024') {
        ...
        document.getElementById('links').innerHTML += `
            ...
            <a href="https://docs.google.com/spreadsheets/d/1XgZTnQ8nd7V_9tWeRQxE7Yx8B8mzc0GtsciOTm5xhDQ/edit#gid=60603194" style="margin-bottom: 10px; display: block;" target="_blank">Agents-to-Q-A-ASAP</a>
